...
React Custom Hooks @ 2023, S. Andrei. Full Sack Developer

- [`useArray`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useArray/useArray.js)
- [`useAsync`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useAsync/useAsync.js)
- [`useClickOutside`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useClickOutside/useClickOutside.js)
- [`useCookie`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useCookie/useCookie.js)
- [`useCopyToClipboard`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useCopyToClipboard/useCopyToClipboard.js)
- [`useDarkMode`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDarkMode/useDarkMode.js)
- [`useDebounce`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDebounce/useDebounce.js)
- [`useDebugInformation`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDebugInformation/useDebugInformation.js)
- [`useDeepCompareEffect`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDeepCompareEffect/useDeepCompareEffect.js)
- [`useEffectOnce`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useEffectOnce/useEffectOnce.js)
- [`useEventListener`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useEventListener/useEventListener.js)
- [`useFetch`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useFetch/useFetch.js)
- [`useGeolocation`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useGeolocation/useGeolocation.js)
- [`useHover`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useHover/useHover.js)
- [`useLongPress`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useLongPress.js/useLongPress.js)
- [`useMediaQuery`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useMediaQuery/useMediaQuery.js)
- [`useOnlineStatus`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useOnlineStatus/useOnlineStatus.js)
- [`useOnScreen`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useOnScreen/useOnScreen.js)
- [`usePrevious`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/usePrevious/usePrevious.js)
- [`useRenderCount`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useRenderCount/useRenderCount.js)
- [`useScript`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useScript/useScript.js)
- [`useStateWithHistory`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useStateWithHistory/useStateWithHistory.js)
- [`useStateWithValidation`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useStateWithValidation/useStateWithValidation.js)
- [`useStorage`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useStorage/useStorage.js)
- [`useTimeout`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useTimeout/useTimeout.js)
- [`useToggle`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useToggle/useToggle.js)
- [`useTranslation`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useTranslation/useTranslation.js)
- [`useUpdateEffect`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useUpdateEffect/useUpdateEffect.js)
- [`useWindowSize`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useWindowSize/useWindowSize.js)

<br />

## 1. [`useArray`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useArray/useArray.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useArray/useArray.js)
...
## 2. [`useAsync`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useAsync/useAsync.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useAsync/useAsync.js)
...
## 3. [`useClickOutside`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useClickOutside/useClickOutside.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useClickOutside/useClickOutside.js)
...
## 4. [`useCookie`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useCookie/useCookie.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useCookie/useCookie.js) 
...
## 5. [`useCopyToClipboard`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useCopyToClipboard/useCopyToClipboard.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useCopyToClipboard/useCopyToClipboard.js)
...
## 6. [`useDarkMode`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDarkMode/useDarkMode.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDarkMode/useDarkMode.js)
...
This custom hook combines two other handy hooks, [`useMediaQuery`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useMediaQuery/useMediaQuery.js) and [`useStorage`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useStorage/useStorage.js), to provide a seamless dark mode experience. It automatically detects the user's preferred color scheme and persists the dark mode state in the browser's local storage.
...
## 7. [`useDebounce`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDebounce/useDebounce.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDebounce/useDebounce.js)
...
## 8. [`useDebugInformation`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDebugInformation/useDebugInformation.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDebugInformation/useDebugInformation.js)
...
## 9. [`useDeepCompareEffect`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDeepCompareEffect/useDeepCompareEffect.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useDeepCompareEffect/useDeepCompareEffect.js)
...
## 10. [`useEffectOnce`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useEffectOnce/useEffectOnce.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useEffectOnce/useEffectOnce.js)
...
## 11. [`useEventListener`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useEventListener/useEventListener.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useEventListener/useEventListener.js)
...
## 12. [`useFetch`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useFetch/useFetch.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useFetch/useFetch.js)
...
## 13. [`useGeolocation`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useGeolocation/useGeolocation.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useGeolocation/useGeolocation.js)
...
## 14. [`useHover`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useHover/useHover.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useHover/useHover.js)
...
## 15. [`useLongPress`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useLongPress.js/useLongPress.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useLongPress.js/useLongPress.js)
...
## 16. [`useMediaQuery`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useMediaQuery/useMediaQuery.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useMediaQuery/useMediaQuery.js)
...
## 17. [`useOnlineStatus`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useOnlineStatus/useOnlineStatus.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useOnlineStatus/useOnlineStatus.js)
...
## 18. [`useOnScreen`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useOnScreen/useOnScreen.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useOnScreen/useOnScreen.js)
...
## 19. [`usePrevious`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/usePrevious/usePrevious.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/usePrevious/usePrevious.js)
...
## 20. [`useRenderCount`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useRenderCount/useRenderCount.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useRenderCount/useRenderCount.js)
...
## 21. [`useScript`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useScript/useScript.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useScript/useScript.js)
...
## 22. [`useStateWithHistory`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useStateWithHistory/useStateWithHistory.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useStateWithHistory/useStateWithHistory.js)
...
## 23. [`useStateWithValidation`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useStateWithValidation/useStateWithValidation.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useStateWithValidation/useStateWithValidation.js)
...
## 24. [`useStorage`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useStorage/useStorage.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useStorage/useStorage.js)
...
## 25. [`useTimeout`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useTimeout/useTimeout.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useTimeout/useTimeout.js)
...
## 26. [`useToggle`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useToggle/useToggle.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useToggle/useToggle.js)
...
## 27. [`useTranslation`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useTranslation/useTranslation.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useTranslation/useTranslation.js)
...
## 28. [`useUpdateEffect`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useUpdateEffect/useUpdateEffect.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useUpdateEffect/useUpdateEffect.js)
...
## 29. [`useWindowSize`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useWindowSize/useWindowSize.js) | [`sources`](https://github.com/shenandrei4/react-custom-hooks/blob/main/src/hooks/useWindowSize/useWindowSize.js)
